...
export default function ProfileInfo() {
  ...
  useEffect(() => {
    if (userData) {
      const birthday = userData.userInfo.birthday
        ? new Date(userData.userInfo.birthday)
        : new Date();
  ...
  const updateUser: any = api.user.updateUserInfo.useMutation({
    onSuccess: () => {
      toast({
        title: "Success",
          ...
          <CardContent className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <label htmlFor="avatar-upload">
                    <Button
                      variant="outline"
                      size="icon"
                      className="absolute -bottom-2 -right-2 cursor-pointer bg-white"
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <Input
                  className="max-w-xl border-gray-200 bg-purple-50/30"
              ...
              <div className="flex items-center">
                <Label className="w-24 text-gray-600">ID：</Label>
                <span className="text-gray-900">{userData?.account}</span>
              </div>

              <div className="flex items-center">
                <Label className="w-24 text-gray-600">邮箱：</Label>
                <span className="text-gray-900">{userData?.email}</span>
              </div>

              {/* Birthday Selection */}
              <div className="flex items-center">
                <Label className="w-24 text-gray-600">生日：</Label>
              ...
              <div className="flex items-center">
                <Label className="w-24 text-gray-600">性别：</Label>
                <span className="text-gray-900">
                  {userData?.userInfo?.gender == 1 ? "男" : "女"}
                </span>
              </div>

              {/* Occupation Selection */}
              <div className="flex items-center">
                <Label className="w-24 text-gray-600">职业：</Label>
                <Select
              ...
              {/* Language Selection */}
              <div className="flex items-center">
                <Label className="w-24 text-gray-600">语言：</Label>
                <Select
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-center">
                  <Label className="w-24 text-gray-600">身高(CM)：</Label>
                  <Input
                ...
                <div className="flex items-center">
                  <Label className="w-24 text-gray-600">体重(KG)：</Label>
                  <Input
                    className="bg-purple-50/30"
              ...
              {/* Bio Section */}
              <div className="flex">
                <Label className="w-24 pt-2 text-gray-600">个人介绍：</Label>
                <Textarea
              ...
              <div className="flex">
                <Label className="w-24 pt-2 text-gray-600">兴趣爱好：</Label>
                <div className="flex-1 rounded-md bg-purple-50/30 p-4">
